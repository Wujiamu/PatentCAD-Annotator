...
namespace PatentMarker.I18n
{
    ...
    public static class Strings
    {
        ...
        {
            get { return En ? "\nClick annotation point for [{0} {1}] (Esc or right-click to finish): " : "\n点击 [{0} {1}] 的标注点（Esc/右键确认或取消）: "; }
        }

        public static string PatMark_PromptFirstDogleg
        {
            get { return En ? "\nClick vertex (Enter to end, Esc or right-click to cancel): " : "\n点击拐点（回车结束，Esc/右键取消）: "; }
        }

        public static string PatMark_PromptNextDogleg
        {
            get { return En ? "\nClick next vertex (Enter to end, Esc or right-click to cancel): " : "\n点击下一个拐点（回车结束，Esc/右键取消）: "; }
        }
        ...
        {
            get { return En ? "\nClick text position (Enter = last vertex, Esc or right-click to cancel): " : "\n点击文字位置（回车=最后拐点，Esc/右键取消）: "; }
        }

        // v3.1：三点模式取点提示 | Three-point mode prompts
        public static string PatMark_PromptDogleg3
        {
            get { return En ? "\n[3-point] Click vertex (point 2 of 3, Esc or right-click to cancel): " : "\n[三点模式] 点击拐点（第 2/3 点，Esc/右键取消）: "; }
        }

        public static string PatMark_PromptTextPos3
        {
            get { return En ? "\n[3-point] Click text position (point 3 of 3, auto-create; Esc or right-click to cancel): " : "\n[三点模式] 点击文字位置（第 3/3 点，自动创建；Esc/右键取消）: "; }
        }
        ...
        {
            get { return En ? "\\nClick standalone text position (Esc or right-click to cancel): " : "\\nStandalone text position (Esc/右键取消): "; }
        }
