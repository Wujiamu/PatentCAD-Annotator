    ...
    public class PatMarkCommand
    {
        ...
        private void CreateLeaderWithText(Database db, Point3d attachPt, List<Point3d> doglegPts, Point3d textPt, string number)
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                // AutoCAD 2007 may normalize the MText attachment while the
                // associative Leader is created. Re-apply both values after
                // association so the requested quadrant is retained.
                mt.Attachment = textAttachment;
                mt.Location = textPt;
