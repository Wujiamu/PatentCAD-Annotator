...
namespace PatentMarker.Palette
{
    ...
    public class EditEntryDialog : Form
    {
        ...
        private void BtnDelete_Click(object? sender, EventArgs e)
        {
            ...
            string? originalModifiedBy = originalMetadata?.ModifiedBy;
            string? originalModifiedAt = originalMetadata?.ModifiedAt;
        ...
        private bool ApplyAndWrite()
        {
            ...
            string? originalModifiedBy = originalMetadata?.ModifiedBy;
            string? originalModifiedAt = originalMetadata?.ModifiedAt;
            string? originalNumber = _entry?.Number;
            string? originalName = _entry?.Name;
